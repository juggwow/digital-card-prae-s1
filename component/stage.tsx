...
import { ArrowRight, Heart, RotateCcw, Stars } from "lucide-react";
...
// Stage 1: Memory
export const StageMemory = ({ onNext, CONFIG }: { onNext: () => void, CONFIG: ConfigType }) => (
    <motion.div
...
export const StageReassurance = ({ onNext, CONFIG }: { onNext: () => void, CONFIG: ConfigType }) => {
...
export const StageInteractive = ({ onNext, CONFIG }: { onNext: () => void, CONFIG: ConfigType }) => {
...
// Stage 4: Finale
export const StageFinale = ({ onRestart, CONFIG }: { onRestart: () => void, CONFIG: ConfigType }) => {
    useEffect(() => {
